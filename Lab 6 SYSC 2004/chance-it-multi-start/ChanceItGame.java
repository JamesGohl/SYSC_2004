...
public class ChanceItGame
{
    ...
    public ChanceItGame(int rounds)
    {
        ...
        players.add(new PlayerOnlyTwelve(dice, "Only 12"));
        players.add(new PlayerMinimumRan(dice, "Minimum Random"));
    ...
    private void announceResults()
    {
        ...
        {
            System.out.println("We have a tie between Players:");
        }
