...
public class Money implements Comparable
{
     ...
     * @param obj An object
     * 
     * @return The sum of "this", obj, and number*cents
     * @throws IllegalArgumentException if number not between 1 and 10 or cents not 0 and 99
     * @throws NullPointerException object is null
     * @throws ClassCastException object is not money class
     */
    public Money addMonies (int number, int cents, Object obj) throws IllegalArgumentException, NullPointerException, ClassCastException
    {
        ...
        if (cents < 0 || cents > 99)
        {
            throw new IllegalArgumentException("Cents not between 0 and 99");
        }
        if(obj == null)
        {
        ...
        {
            throw new ClassCastException("Class Cast exception object not a money class");
        }
